...
<body>
    <div class="container">
        <div class="profile-header">
            <p> <img src="{{ asset('images/profile.jpg') }}" alt="Profile Picture"></p>
            <h1>My Portfolio</h1>
        ...
        <div class="profile-info">
            ...
            @if (Auth::check() && $profile)
                <p><i class="fas fa-user"></i> : {{ $profile->name }} </p>
                <p><i class="fas fa-birthday-cake"></i> : {{ $profile->birthdate }}, {{ $profile->birthplace }}</p>
                <p><i class="fas fa-phone"></i> : {{ $profile->telephone }} </p>
            @else
                <p><i class="fas fa-user"></i> : Annete Ompusunggu </p>
                <p><i class="fas fa-birthday-cake"></i> : 23-04-2004, Surabaya</p>
                <p><i class="fas fa-phone"></i> : 085850743564 </p>
            @endif
        ...
        <div class="contact-info">
            ...
            <a href="mailto:jovanca3anete@gmail.com">Send Email</a>
        </div>
    </div>
